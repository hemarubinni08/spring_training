...
<div class="card">
    ...
    <div class="top-actions">
        ...
        <a href="/node/getall" class="back-btn">Go back to list</a>
    </div>

    <h2>Add a Node</h2>

    <form:form action="/node/add" method="post" modelAttribute="nodeDto">
        ...
        <input type="submit" value="Add Path" class="btn-submit"/>
