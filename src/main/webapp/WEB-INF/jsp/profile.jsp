...
<body>
    ...
    <form:form
        ...
        action="/user/updateUserByIdJpa/${userDto.id}"
    >

        Name:
        <form:input path="name" value="${userDto.name}" />
        <br />
        <br />
        ...
        Phone:
        <form:input path="phoneNo" value="${userDto.phoneNo}" />
        <br />
        <br />

        Username:
        <form:input path="userName" value="${userDto.userName}" />
        <br />
        <br />

        Password:
        <form:password path="password" value="${userDto.password}" />
        <br />
        <br />

        Age:
        <form:input path="age" value="${userDto.age}" />
        <br />
        <br />
