...
<div class="card">
    ...
    <table>
        ...
        <c:forEach var="role" items="${roles}">
            <tr>
                <td>
                    <a href="${pageContext.request.contextPath}/role/getRole/${role.id}">
                        ${role.id}
                    </a>
                </td>
                ...
                <td class="actions">
                    <a href="${pageContext.request.contextPath}/role/getRole/${role.id}" title="Edit">
                        <i class="fa-solid fa-pen-to-square"></i>
                    </a>

                    <a href="${pageContext.request.contextPath}/role/deleteRole/${role.id}"
                       class="delete"
                       title="Delete">
