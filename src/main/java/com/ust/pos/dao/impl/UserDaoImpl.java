...
public class UserDaoImpl implements UserDao {
    ...
    public Boolean save(UserDto userDto) {
        ...
        jdbcTemplate.update(sqlQ, userDto.getAge(), userDto.getEmail(), userDto.getUserName(), encodePass, userDto.getPhoneNo());
        return false;
    }

    public User findByEmail(String email) {
        String sqlQ = "SELECT * FROM user WHERE email= ? ";
        List<User> userList = jdbcTemplate.query(sqlQ, new Object[]{email},
