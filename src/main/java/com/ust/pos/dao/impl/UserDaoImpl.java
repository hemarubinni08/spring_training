...
public class UserDaoImpl implements UserDao {
    ...
    public void updateValue(UserDto userDto) {
        String sq1 = "UPDATE user SET age = ?, date_of_birth = ?, email = ?, name = ?, phone_no = ?, user_name =? , role = ?, roles = ? WHERE id = ? ";
        jdbcTemplate.update(sq1, userDto.getAge(), userDto.getDateOfBirth(), userDto.getEmail(), userDto.getName(), userDto.getPhoneNo(), userDto.getUserName(), userDto.getRole(), userDto.getRoles(), userDto.getId());
